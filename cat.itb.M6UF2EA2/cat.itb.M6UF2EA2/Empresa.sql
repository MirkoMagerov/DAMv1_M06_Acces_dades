...
INSERT INTO EMP VALUES (7934,'MUNYOZ','EMPLEAT',7782, '1982-01-23', 169000,NULL,10);
...
CREATE INDEX CLIENT_REPR_CLI ON CLIENT (REPR_COD, CLIENT_COD);


INSERT INTO CLIENT (CLIENT_COD, NOM, ADRECA, CIUTAT, ESTAT, CODI_POSTAL, AREA, 
...
CREATE TABLE IF NOT EXISTS COMANDA  (
 ...
 DATA_TRAMESA        DATE,
 TOTAL               DECIMAL(8,2),
 FOREIGN KEY (CLIENT_COD) REFERENCES CLIENT(CLIENT_COD) on delete cascade );

CREATE INDEX COMANDA_DATA_NUM ON COMANDA (COM_DATA,COM_NUM);
CREATE INDEX COMANDA_TRAMESA_NUM ON COMANDA (DATA_TRAMESA,COM_NUM);
...
CREATE TABLE IF NOT EXISTS DETALL  (
 ...
 FOREIGN KEY (COM_NUM) REFERENCES COMANDA(COM_NUM)  on delete cascade,
 FOREIGN KEY (PROD_NUM) REFERENCES PRODUCTE(PROD_NUM));


CREATE INDEX DETALL_PROD_COM_DET ON DETALL (PROD_NUM,COM_NUM,DETALL_NUM);
